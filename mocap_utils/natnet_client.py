...
import copy
import time
import data_descriptions as DataDescriptions
import mocap_data as MoCapData
...
class NatNetClient:
    ...
    def __init__(self):
        ...
        if IN_FIELD_ROOM:
            self.server_ip_address = "192.168.110.119"  # IN_FIELD_ROOM Suite
        else:
    ...
    def __data_thread_function(self, in_socket, stop, gprint_level):
        ...
        while not stop():
            ...
            if time.time() - last_time > 0.2:
                assert False, "Mocap stop sending data!"
